...
class AppColors {
  ...
  static const Color gradientBlueLight = Color(0xFF5AC6FA); // Updated to match design

  /// Darker blue color for gradient background.
  static const Color gradientBlueDark = Color(0xFF388CFE); // Updated to match design
}
